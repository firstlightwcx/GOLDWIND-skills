...
13. Plan Goldwind正文页 for higher information density on 100-inch projectors: default each content slide to 5-9 useful information units, compact 3×2 / 3×3 cards, dense tables, KPI groups, or image+text layouts. Use smaller body type when needed; do not create sparse slides with only 2-4 bullets unless the source is truly limited or the user requests a breathing page.
